...
#define STRING_CONFIG_H_AUTHOR "(SolidX, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_SOLIDX
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "SolidX 3D Printer"
...
#define EXTRUDE_MAXLENGTH 1400 //prevent extrusion of very large distances.
...
const bool Z_AUX_ENDSTOP_INVERTING = false;
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {71.43, 71.43, 1259.86, 129}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 50, 25}    // (mm/sec)
